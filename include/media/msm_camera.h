...
/* LGE_CHANGE_S, fix recording, panorama and etc. in G Project, 2013.01.06, jungryoul.choi@lge.com */
...
#endif
/* LGE_CHANGE_E, fix recording, panorama and etc. in G Project, 2013.01.06, jungryoul.choi@lge.com */
};
