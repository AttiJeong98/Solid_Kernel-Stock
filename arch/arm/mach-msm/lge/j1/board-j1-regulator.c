...
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s5 =
	...
	SAW_VREG_INIT(S5, "8921_s5",	       750000, 1450000);
#else
	SAW_VREG_INIT(S5, "8921_s5",	       750000, 1300000);
#endif
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s6 =
#ifdef CONFIG_CPU_OVERCLOCK
	SAW_VREG_INIT(S6, "8921_s6",	       750000, 1450000);
#else
...
struct regulator_init_data msm8064_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
#ifdef CONFIG_CPU_OVERCLOCK
	SAW_VREG_INIT(8821_S0, "8821_s0",       750000, 1450000);
#else
	SAW_VREG_INIT(8821_S0, "8821_s0",       750000, 1300000);
#endif
struct regulator_init_data msm8064_saw_regulator_pdata_8821_s1 =
#ifdef CONFIG_CPU_OVERCLOCK
	SAW_VREG_INIT(8821_S1, "8821_s1",       750000, 1450000);
#else
 ...
 * It is setting for HEADSET MICBIAS that is always on */
 //[LGE] seungkyu.joo, 2012-12-18 , HW Request for enabling apple headset mic
	...
	||defined(CONFIG_MACH_APQ8064_J1R) || defined(CONFIG_MACH_APQ8064_J1B) || defined(CONFIG_MACH_APQ8064_J1TL)
